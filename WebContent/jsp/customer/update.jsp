...
%>
	<h3>用户ID：<input name="customer.id" value="<%=id %>"/></h3>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<TR>
								...
								<INPUT class=textbox id=sChannel2
											style="WIDTH: 180px" maxLength=50 name="customer.name" value="<%=name %>">
								</td>
								<td>客户级别 ：</td>
								<td>
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 name="customer.level" value="">
								</td>
							</TR>
							...
							<TR>
								...
								<td>
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 name="customer.source" value="">
								</td>
								<td>联系人：</td>
								<td>
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 name="customer.linkman" value="">
								</td>
							</TR>
							<TR>
								<td>固定电话 ：</td>
								<td>
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 name="customer.phone" value="">
								</td>
								<td>移动电话 ：</td>
								<td>
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 name="customer.mobile" value="">
								</td>
							</TR>
							<TR>
								<td>所属行业 ：</td>
								<td>
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 name="customer.industry" value="">
							</TR>
