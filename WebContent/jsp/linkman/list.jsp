...
<body>
    ...
    <thead>
		...
		<tr>
			...
			<td>
				<button class="button-1"><a class="button" href="linkman_delete.action?linkman.id=${linkman.id}">删除</a>&nbsp;</button>
				<button class="button-2"><a class="button" href="${ pageContext.request.contextPath }/jsp/linkman/update.jsp?linkman.id=${linkman.id}">修改</a></button>
			</td>
		</tr>
		</c:forEach>
	</table>
									...
									<TD>
										<TABLE id=grid
											...
											<TBODY>
												...
												<c:forEach items="${sessionScope.list}" var="linkman">
												<TR
